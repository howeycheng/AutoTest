...
class Scene(MPTTModel):
    rqid = models.IntegerField(db_column='RQID', blank=True, null=True)
    name = models.CharField(db_column='NAME', max_length=400, blank=True, null=True)
